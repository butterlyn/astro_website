...
| Tina “Log in through your site”            | Deployment is complete; your browser login and authenticated editing proof are pending. The first attempt encountered a stale DNS result from the local router; public Cloudflare, Google and Quad9 resolvers return the new hostname correctly.                                                                                                                                                              |
