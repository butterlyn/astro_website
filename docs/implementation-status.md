...
| Phase 1    | Isolated main-based baseline; frozen dependency pins; useful linting; permanent checks retaining `Setup validation`; no deployment triggers                                                                    | Hosted preview workflow/configuration is completed with Phase 2; bootstrap evidence below                                              |
